...
class KeyValueMappingWizard extends \Widget {
    ...
    protected $arrHeadOptions = [];
    protected $arrDataTypes = [];
    ...
    protected function parseCSVMap( &$intTabindex ) {
        ...
        for ( $intIndex = 0; $intTotalColumns > $intIndex; $intIndex++ ) {
            ...
            $arrValue = isset( $this->varValue[ $intIndex ] ) ? $this->varValue[ $intIndex ] : [];
    ...
    protected function getColumnOptions( $arrValue ) {
